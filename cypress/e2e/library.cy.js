describe('check kirkendall', () => {
    ...
    it('checks new books', () => {
        ...
        cy.get('.new-releases__link a').first().should('have.text', 'How to survive in the age of dinosaurs : a handy guide to dodging deadly predators, riding out mega-monsoons, and escaping other perils of the prehistoric');
    })
