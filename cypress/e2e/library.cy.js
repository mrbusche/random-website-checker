describe('check kirkendall', () => {
    ...
    it('checks new books', () => {
        ...
        cy.get('.new-releases__link a').first().should('have.text', 'Super simple science experiments for curious kids : 100 awesome activities using supplies you already own');
    })
