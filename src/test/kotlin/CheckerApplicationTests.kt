...
internal class CheckerApplicationTests {
    ...
    fun `Test ESPN Dynasty Ranks Update`() {
        ...
        assertEquals("Aug 29, 2021", CheckerService.retrieveDynastyDate(dynastyUrl))
    }
    ...
    fun `Test RHEL7 Version`() {
        val reportUrl = "https://github.com/jonathanlermitage/software-updates-bot/blob/master/report/report.md"
        assertEquals("7.9-476", CheckerService.retrieveSoftwareVersions(reportUrl, "RHEL7"))
    }

    @Test
    fun `Test RHEL7Minimal Version`() {
        val reportUrl = "https://github.com/jonathanlermitage/software-updates-bot/blob/master/report/report.md"
        assertEquals("7.9-479", CheckerService.retrieveSoftwareVersions(reportUrl, "RHEL7Minimal"))
    }
