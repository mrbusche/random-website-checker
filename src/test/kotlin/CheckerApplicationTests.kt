...
internal class CheckerApplicationTests {
    ...
    fun `Test ESPN Dynasty Ranks Update`() {
        ...
        assertEquals("Jul 27, 2021", CheckerService.retrieveDynastyDate(dynastyUrl))
    }

    @Test
    fun `Test ETR Dynasty Ranks Update`() {
        val dynastyUrl = "https://establishtherun.com/etrs-dynasty-rankings/"
        assertEquals("Aug 11, 2021", CheckerService.retrieveETRDynastyDate(dynastyUrl))
    }
    ...
    fun `Test RHEL7 Version`() {
        val reportUrl = "https://github.com/jonathanlermitage/software-updates-bot/blob/master/report/report.md"
        assertEquals("7.9-437", CheckerService.retrieveSoftwareVersions(reportUrl, "RHEL7"))
    }

    @Test
    fun `Test RHEL7Minimal Version`() {
        val reportUrl = "https://github.com/jonathanlermitage/software-updates-bot/blob/master/report/report.md"
        assertEquals("7.9-438", CheckerService.retrieveSoftwareVersions(reportUrl, "RHEL7Minimal"))
    }

    @Test
    fun `Test Maven Version`() {
        val reportUrl = "https://github.com/jonathanlermitage/software-updates-bot/blob/master/report/report.md"
        assertEquals("3.8.2", CheckerService.retrieveSoftwareVersions(reportUrl, "Maven"))
    }
