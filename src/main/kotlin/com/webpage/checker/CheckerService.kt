...
class CheckerService {
    companion object {
        ...
        private val EXISTING_PROJECTS = arrayListOf("Ankeny Parks Maintenance Facility Improvements","Ankeny Senior Community Center","Brownstones at The District Phase 2","Casey's General Store","Centennial Estates Plat 2","Centennial Ridge Plat 2","Chalet at Prairie Trail Plat 1","Chautauqua Park Townhomes Plat 2","Corporate Woods Business Park Plat 5","Courtyards at Harvest Ridge Plat 1","Deer Creek South Townhomes Plat 2","Dewey Jeep Dodge Collision Center","District Lofts","Extra Space Storage","Heritage Village Townhouse Plat 5","Hidden Creek Commercial Phase 2","Hulsizer Commercial Lots 1 &amp; 2","IBEW Local 347","Kreg Tool World Headquarters","Metro Crossing","Mister Car Wash","Northgate Plat 3","Otter Creek Commercial Plat 3","Parkway North Plat 3","Peterbilt","Plaza Shops","Purfood West Office Addition","Ryan Warehouse","Starbucks","Sunnyview Care Center - 2019 Expansion","The Crossings at Deer Creek Plat 9","The District Towers","The Village at Aspen Ridge Estates Plat 1","TJX Homegoods","Trestle Ridge Estates Plat 5","Veridian Credit Union")
